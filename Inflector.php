...
class Inflector
{
    ...
    public static function slugify($input)
    {
        ...
        // transliterate
        // ISSUE: iconv differences between windows and unix (unix drops character)
        //        if (function_exists('iconv')) {
        //            $output = iconv('utf-8', 'us-ascii//TRANSLIT', $output);
        //        }
        $output = self::transliterate($output);
     ...
     *
     * @param  string $input The string you want to transliterate.
